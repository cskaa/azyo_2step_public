...
class DocTypeView extends AzyoView {
    ...
    init_view() {
        ...
        this.next_btn.addEventListener('click', ev => {
            ...
            var req_body = this.args['creds']
            req_body['required'] = {'document_type': 'LICENCE', 'country': 'IND', 'state': 'MH', "step": "DOCTYPE", "meta": this.args['meta']}
    ...
    #init_root(root_div) {
        ...
        this.root.addEventListener('backto', ev => {
            ...
            if (ev.detail['success']) {
                ...
                view.send_data(view.url, req_body, res => {console.log('backto response from server', res)})
